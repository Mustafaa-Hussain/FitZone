...
import com.example.fitzone.retrofit_requists.data_models.all_posts.Post;
...
public class PostsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PostsAdapter(Activity activity, List<Post> arrayOfPosts) {
        if (activity == null)
            return;
    ...
    //get user level
    private void getUserLevel(String username) {
        ...
        call.enqueue(new Callback<UserDataResponse>() {
            ...
            public void onResponse(Call<UserDataResponse> call, Response<UserDataResponse> response) {
                if (response.body() == null)
                    return;
                userLevelWithTag.put(String.valueOf(response.body().getId()), response.body().getLevel());
